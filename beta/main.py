...
jobs.append(schedule.every().day.at("09:05:00").do(run_script, 'filter_instruments_upstox.py'))
jobs.append(schedule.every().day.at("09:05:30").do(run_script, 'filter_instruments_zerodha.py'))
jobs.append(schedule.every().day.at("09:06:00").do(run_script, 'fetch_historical_data.py'))
jobs.append(schedule.every().day.at("09:07:30").do(run_script, 'calc_safe_volume.py'))
jobs.append(schedule.every().day.at("09:08:00").do(run_script, 'fetch_margin.py'))
jobs.append(schedule.every().day.at("09:08:30").do(run_script, 'calc_margin.py'))
